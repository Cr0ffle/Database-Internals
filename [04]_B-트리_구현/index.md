...
![4-1](data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1327 608"></svg>)
...
![4-2](data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1259 410"></svg>)

- 가장 오른쪽 자식 노드가 분할되고 부모에 새로운 셀이 추가되면 부모의 마지막 포인터도 다시 설정해야 한다.
- 노드 분할 시 마지막 포인터는 새로운 노드를 가리키도록 업데이트 된다.

![4-3](data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1278 477"></svg>)
...
![4-4](https://raw.githubusercontent.com/sup2is/dev-note/master/db//images/database-internals/4-4.jpeg)
...
![4-5](data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1227 485"></svg>)
...
![4-6](data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1155 732"></svg>)
...
- 페이지 셀의 이진 검색은 먼저 중간 셀 오프셋을 선택하고 해당 위치의 키와 검색 키를 비교해 왼쪽과 오른쪽 중 진행 방향을 결정한다.
 ...
 ![4-6](data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1266 689"></svg>)
...
![4-6](data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1171 836"></svg>)
...
![4-9](data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1339 608"></svg>)
...
![4-10](https://raw.githubusercontent.com/sup2is/dev-note/master/db//images/database-internals/4-10.jpeg)
...
![4-10](https://raw.githubusercontent.com/sup2is/dev-note/master/db//images/database-internals/4-11.jpeg)
